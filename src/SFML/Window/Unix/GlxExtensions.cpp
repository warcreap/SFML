...
{
    int numFailed = 0;
    sf_ptrc_glXCreateGLXPbufferSGIX = (GLXPbufferSGIX (CODEGEN_FUNCPTR *)(Display *, GLXFBConfigSGIX, unsigned int, unsigned int, int *))IntGetProcAddress("glXCreateGLXPbufferSGIX");
    if(!sf_ptrc_glXCreateGLXPbufferSGIX) numFailed++;
    sf_ptrc_glXDestroyGLXPbufferSGIX = (void (CODEGEN_FUNCPTR *)(Display *, GLXPbufferSGIX))IntGetProcAddress("glXDestroyGLXPbufferSGIX");
    if(!sf_ptrc_glXDestroyGLXPbufferSGIX) numFailed++;
    sf_ptrc_glXGetSelectedEventSGIX = (void (CODEGEN_FUNCPTR *)(Display *, GLXDrawable, unsigned long *))IntGetProcAddress("glXGetSelectedEventSGIX");
    if(!sf_ptrc_glXGetSelectedEventSGIX) numFailed++;
    sf_ptrc_glXQueryGLXPbufferSGIX = (int (CODEGEN_FUNCPTR *)(Display *, GLXPbufferSGIX, int, unsigned int *))IntGetProcAddress("glXQueryGLXPbufferSGIX");
    if(!sf_ptrc_glXQueryGLXPbufferSGIX) numFailed++;
    sf_ptrc_glXSelectEventSGIX = (void (CODEGEN_FUNCPTR *)(Display *, GLXDrawable, unsigned long))IntGetProcAddress("glXSelectEventSGIX");
    if(!sf_ptrc_glXSelectEventSGIX) numFailed++;
    return numFailed;
}
